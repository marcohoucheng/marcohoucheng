...
\geometry{left=1.8cm, top=1.6cm, right=1.8cm, bottom=1.6cm, footskip=.5cm}
...
\mobile{+353 876667840}
\email{marcohoucheng@gmail.com}
%\dateofbirth{January 1st, 1970}
\homepage{marcohoucheng.github.io} 
\github{marcohoucheng}
\linkedin{marcohoucheng}
% \gitlab{gitlab-id}
...
% \input{cv/academic_achievements}
% \input{cv/interests}
