...
\cventry
  ...
  {Oct 2024 - Current} % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
      \item {Developed \textbf{Nvidia GPU} support for Vaultree's \textbf{proprietary Fully Homomorphic Encryption} from academic papers.}
      ...
      \item {\textbf{Developed} and \textbf{published} a Python library integrating Rust via Maturin, PyO3, and automated \textbf{builds/releases} through \textbf{GitHub Actions}.}
      ...
      \item {Maintained reproducible \textbf{Python environments} using \textbf{uv} for dependency and version management.}
      \item {\textbf{Represented the engineering team} in external partnership calls and technical discussions.}
